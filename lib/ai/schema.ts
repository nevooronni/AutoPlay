...
export const TailoredApplicationSchema = z.object({
  ...
  email_html: z.string().describe("A short, punchy email to the employer applying for the role, based on the cover letter but formatted appropriately for an email body. Use semantic HTML suitable for rendering in a rich text editor. Do NOT include html/head/body tags. Only use tags like p, br, strong.")
});
