...
user should be able to tweak added resume to jobs description resume should pass ATS scan filters(AI should do this)
...
user should be able to search online for potential companies and jobs to apply to matching the skills they have.
user should be able to reach out to contacts they find on the websites of the companies.
### Tech Stack
- Next.js
- Playwright
- Supabase
